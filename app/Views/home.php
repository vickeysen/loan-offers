...
<body>
    ...
    <div class="body-inner">
        ...
        <div id="slider" class="inspiro-slider slider-halfscreen dots-creative">
            ...
            <!-- Slide 1 -->
            <div class="slide kenburns" data-bg-image="homepages/corporate-v7/images/1.jpg">
                ...
                <div class="container">
                    <div class="slide-captions text-center text-light">
                        ...
                        <div><button type="button" class="btn btn-primary">Explore</button>
            ...
            <!-- Slide 2 -->
            <div class="slide kenburns" data-bg-image="homepages/corporate-v7/images/2.jpg">
                <div class="bg-overlay"></div>
                <div class="container">
        ...
        <section class="background-grey text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3"><a href="#" class="btn btn-roundeded">Purchase POLO</a> </div>
                </div>
            </div>
        </section>
        <!-- end: Call to action -->
        ...
        <!-- Our numbers -->
        <section class="p-t-100 p-b-100" data-bg-parallax="homepages/corporate-v7/images/parallax/4.jpg">
            <div class="bg-overlay"></div>
            <div class="container xs-text-center sm-text-center text-light">
                <div class="row">
                    <div class="col-lg-5 p-b-60">
                        <h2>Our Numbers & Smoth parallax</h2>
                        <p class="lead">Nulla varius consequat magna, id molestie ipsum volutpat quis. A true story, that never been told!. Fusce id mi diam, non ornare. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, id molestie ipsum volutpat quis. facilisis
                            ut venenatis eu.</p>
                        <a href="#services" class="btn btn-light btn-outline btn-roundeded">Our Services</a>
                    </div>
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-lg-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <p class="lead">Nulla varius consequat magna, id molestie ipsum volutpat quis. A true story, that never been told!.</p>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="accordion fancy radius clean">
                            <div class="ac-item ac-active">
                                ...
                                <div class="ac-content ac-active">We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!.
                                    <br />
